...
--- CONFIG ---
local attempts = 3 -- Quantidade de tentativas que um usuário pode ter.
...
AddEventHandler("Fax:ServerPassword:ShowPasswordPrompt", function()
    local password = KeyboardInput("Digite a senha do servidor (" .. attempts .. " attempt" .. (attempts == 1 and "" or "s") .. " remaining)", "", 30)
    attempts = attempts - 1
...
AddEventHandler('Fax:ServerPassword:PassedPassword', function()
    ...
    TriggerEvent('chatMessage', "^2Senha Valida!")
end)
